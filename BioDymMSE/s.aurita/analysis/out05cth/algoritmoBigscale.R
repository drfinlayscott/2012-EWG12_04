...
MSEsims01cth <- split(scn, scn)
for(i in 1:length(MSEsims01cth)){ 
	try(MSEsims01cth[[i]] <- mseBD(OM=OM, start=iniyr, sr=srBH, srRsdl=srRsdl, bounds=bounds, Btrig=scn[i,"Btrig"], Ftar=scn[i,"Ftar"], aLag=scn[i, "aLag"], srvBias=scn[i,"srvBias"], cthBias=scn[i,"cthBias"], IEM=scn[i,"IEM"], clag=scn[i,"clag"], am="cth"))
}

save(MSEsims01cth, file="RData.MSEsims01cth")
...
MSEsims01srv <- split(scn, scn)
for(i in 1:length(MSEsims01srv)){ 
	try(MSEsims01srv[[i]] <- mseBD(OM=OM, start=iniyr, sr=srBH, srRsdl=srRsdl, bounds=bounds, Btrig=scn[i,"Btrig"], Ftar=scn[i,"Ftar"], aLag=scn[i, "aLag"], srvBias=scn[i,"srvBias"], cthBias=scn[i,"cthBias"], IEM=scn[i,"IEM"], clag=scn[i,"clag"], slag=scn[i,"slag"], am="srv"))
}

save(MSEsims01srv, file="RData.MSEsims01srv")
